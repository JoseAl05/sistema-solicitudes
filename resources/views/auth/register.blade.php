            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="establecimiento" class="col-md-4 col-form-label text-md-right">{{ __('Establecimiento') }}</label>

                            <div class="col-md-6">
                                <input id="establecimiento" type="text" class="form-control" name="establecimiento" required>
